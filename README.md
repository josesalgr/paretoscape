...
You can also use convenience wrappers such as `set_solver_gurobi()`,
`set_solver_cplex()`, `set_solver_cbc()`, or `set_solver_symphony()`.
...
- and the multi-objective methods `set_method_weighted_sum()`,
