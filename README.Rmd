...
- the documentation of `create_problem()`, `add_actions()`, `add_effects()`, and `solve()`,
- and the multi-objective methods `set_method_weighted_sum()`, `set_method_epsilon_constraint()`, and `set_method_augmecon()`.
