...
extern SEXP _mosap_rcpp_add_constraint_action_max_per_pu(SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"_mosap_rcpp_add_constraint_action_max_per_pu", (DL_FUNC) &_mosap_rcpp_add_constraint_action_max_per_pu, 5},
