...
- Make sure the package passes `R CMD check`, for example with
  ...
  If the package does not pass checks cleanly, it is a good idea to ask
...
- Make your changes, commit them, and then create a pull request with
  ...
  following the prompts in your browser.
...
- [`create_problem()`](https://josesalgr.github.io/multiscape/reference/create_problem.md)
  creates the core problem object,
...
- [`set_solver()`](https://josesalgr.github.io/multiscape/reference/set_solver.md)
  configures the optimisation solver,
- [`compile_model()`](https://josesalgr.github.io/multiscape/reference/compile_model.md)
  builds the optimisation model,
- [`solve()`](https://josesalgr.github.io/multiscape/reference/solve.md)
  executes the optimisation workflow,
